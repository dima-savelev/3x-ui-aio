...
### 9. WARP
По умолчанию в панели настроен warp и через него идет весь трафик.Это можно изменить, зайдя в  
**Настройки Xray -> Исходящие подключения** и выставив direct первым. Также можно настроить маршрутизацию зайдя в **Расширенный шаблон -> Маршрутизация**.
